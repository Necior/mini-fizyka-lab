...
\subsection{Badanie zależności okresu drgań wahadła od kąta wychylenia}
 ...
 Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut volutpat nisi vitae est viverra, nec aliquet nulla dapibus. Integer pretium cursus libero, nec sagittis risus facilisis sed. Aenean suscipit iaculis risus, varius semper leo pharetra sagittis. Vivamus sapien velit, pulvinar vitae nibh sit amet, vulputate aliquam turpis. Integer eu sagittis felis. Donec semper lectus dolor, eu fringilla orci congue eget. Suspendisse dignissim justo feugiat, elementum urna dapibus, tempor purus. Aenean id fermentum eros.

Nulla ultricies vehicula tempor. Morbi rutrum velit justo, nec egestas sapien fermentum in. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse tempor nibh vitae purus dictum porta. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Suspendisse potenti. Nulla mollis mollis libero, a rutrum nulla congue non. Praesent elementum tincidunt arcu, ut posuere elit pulvinar non. Morbi vitae enim lectus. Vivamus id tincidunt enim. Etiam auctor quis justo non tempus. In sed ante leo. Aliquam a augue at lorem elementum commodo quis vitae urna. Donec eget risus auctor, volutpat neque vitae, lobortis quam.
...
Uzależniono w ten sposób długość wahadła od okresu drgań. Po dokonaniu pomiarów okresu przy zmiennej długości wahadła można skorzystać z regresji liniowej i wyznaczyć nachylenie prostej.
...
Wyniki pomiarów wraz z obliczeniami cząstkowymi znajdują się w tabeli \ref{pomiary_2}.
...
Uzyskane wartości wyniosły:
\begin{align*}
a &= -9.789(31) \\
b &= 909.4(1.5)
\end{align*}

Zatem przekształcając $a$ zgodnie z (\ref{eq:l_wzg}):  $ g' = 9.789(31) $.
